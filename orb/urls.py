...
urlpatterns = patterns('',
    ...
    url(r'^resource/(?P<id>\d+)/link/(?P<url_id>\d+)/delete/$', 'orb.views.resource_url_delete_view', name="orb_resource_delete_url"),
    url(r'^resource/(?P<id>\d+)/file/(?P<file_id>\d+)/delete/$', 'orb.views.resource_file_delete_view', name="orb_resource_delete_file"),
